package ru.moonlightapp.backend.service.auth.controller;
...
import ru.moonlightapp.backend.core.docs.annotation.*;
import ru.moonlightapp.backend.core.exception.ApiException;
import ru.moonlightapp.backend.core.storage.model.TokenPair;
import ru.moonlightapp.backend.service.auth.dto.*;
import ru.moonlightapp.backend.service.auth.model.TokenPairModel;
import ru.moonlightapp.backend.service.auth.service.EmailConfirmationService;
import ru.moonlightapp.backend.service.auth.service.EmailConfirmationService.ProofKeyConsumer;
import ru.moonlightapp.backend.service.auth.service.RecoveryService;
import ru.moonlightapp.backend.service.auth.service.RegistrationService;
...
public final class AuthProcessingController {
    ...
    public void processSignUpCodeRequest(@Valid SignUpCodeRequestDto dto, HttpServletResponse response) throws ApiException {
        registrationService.processConfirmationRequest(dto.email(), dto.name(), dto.isRenew(), ProofKeyConsumer.httpHeaderBased(response));
    }
    ...
    public void processSignUpConfirmation(@Valid SignUpConfirmationDto dto, HttpServletRequest request) throws ApiException {
        registrationService.processEmailConfirmation(dto.email(), dto.code(), EmailConfirmationService.extractProofKey(request));
    }
    ...
    public void processSignUpComplete(@Valid SignUpCompleteDto dto, HttpServletRequest request, HttpServletResponse response) throws ApiException {
        registrationService.registerNewUser(
                dto.email(), dto.password(), EmailConfirmationService.extractProofKey(request),
    ...
    public void processRecoveryCodeRequest(@Valid RecoveryCodeRequestDto dto, HttpServletResponse response) throws ApiException {
        recoveryService.processConfirmationRequest(dto.email(), dto.isRenew(), ProofKeyConsumer.httpHeaderBased(response));
    }
    ...
    public void processRecoveryConfirmation(@Valid RecoveryConfirmationDto dto, HttpServletRequest request) throws ApiException {
        recoveryService.processEmailConfirmation(dto.email(), dto.code(), EmailConfirmationService.extractProofKey(request));
    }
    ...
    public void processRecoveryChangePassword(@Valid RecoveryChangePasswordDto dto, HttpServletRequest request) throws ApiException {
        recoveryService.performRecovery(dto.email(), dto.password(), EmailConfirmationService.extractProofKey(request));
    }
